...
CREATE TABLE IF NOT EXISTS `bhgj4cghyzfv4zpwtjit`.`Restaurantes` (
  `id` varchar(50), 
  `rating` int(1), 
  `name` varchar(40), 
  `site` varchar(40), 
...
INSERT INTO `bhgj4cghyzfv4zpwtjit`.`Restaurantes` (`id`, `rating`, `name`, `site`, `email`, `phone`, `street`, `city`, `state`, `lat`, `lng`) VALUES 
